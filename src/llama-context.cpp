...
llama_perf_context_data llama_context::perf_get_data() const {
    ...
    data.t_compute_start_us = t_compute_start_us;
...
void llama_perf_context_print(const llama_context * ctx) {
    ...
    printf("%s:        start_time_stamp: %d us\n", __func__, data.t_start_ms);
...
//             data.t_from_2nd_ms, 
//             data.n_eval - 1, 
//             data.t_from_2nd_ms / (data.n_eval - 1), 
//             1e3 / data.t_from_2nd_ms * (data.n_eval - 1));
}
